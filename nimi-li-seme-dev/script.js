...
const wordsets = ["core", "common", "uncommon"]
...
function getAllowedKeys() {
  return Object.keys(window.tokidata).filter(x => (!window.tokidata[x].cat || window.tokidata[x].cat == wordsets[config.wordset]))
}
